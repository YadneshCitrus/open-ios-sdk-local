...
-(IBAction)savedOptionAction:(id)sender
{
    ...
    self.savedOptionsViewController.view.frame = CGRectMake(0.0f, 120.0f, 320, 448.0f);
...
-(IBAction)netBankingAction:(id)sender
{
    ...
    self.netBankingViewController.view.frame = CGRectMake(0.0f, 120.0f, 320, 448.0f);
...
-(IBAction)debitCardAction:(id)sender
{
    ...
    self.cardPayViewController.view.frame = CGRectMake(0.0f, 120.0f, 320, 448.0f);
