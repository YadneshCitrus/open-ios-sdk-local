 ...
 */
NS_CLASS_AVAILABLE_IOS(6_0) @interface CTSTextFieldValidator : UITextField<UITextFieldDelegate>{
 ...
 */
-(void)addConfirmValidationTo:(CTSTextFieldValidator *)txtPassword withMsg:(NSString *)msg;
